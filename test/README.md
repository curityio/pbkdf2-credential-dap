...
4. Run `./docker_run.sh`. This will start the Curity Identity Server with the plugin already configured as described in the main [README](../README.rst). 
5. Run `./import_data.sh` to create a test account with the properly hashed password.
